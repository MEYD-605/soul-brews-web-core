...
import { o as objectType, e as dateType, f as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, g as escape, h as renderUniqueStylesheet, i as renderScriptElement, j as createHeadAndContent, r as renderComponent } from './astro/server_DU12jbRN.mjs';
import { r as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_BgNISshD.mjs';
import { V as VALID_INPUT_FORMATS } from './consts_47CwkweC.mjs';
import { u as unflatten } from './parse_BeDHJKc-.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_xSSKgQUS.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CJxUxjO7.mjs').then(n => n._);
