...
export default function AstroOracle() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (foundSign) {
      ...
      // Simulate sending data to n8n webhook (placeholder)
      ...
      // In a real implementation, you would use fetch to send data to n8n
      // fetch('https://n8n.example.com/webhook/astro-oracle', {
      //   method: 'POST',
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <button
                ...
                className="px-4 py-2 border border-theme-primary text-theme-primary font-medium rounded-md hover:bg-theme-secondary transition-colors flex-1"
              >
                Try Random
              </button>
            </div>
